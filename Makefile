...
create_release_branch: ## Create Release Branch and push it to origin
	git checkout -b "release/${ONDEWO_PACKAGE_VERSION}"
	git push -u origin "release/${ONDEWO_PACKAGE_VERSION}"

create_release_tag: ## Create Release Tag and push it to origin
	git tag -a ${ONDEWO_PACKAGE_VERSION} -m "release/${ONDEWO_PACKAGE_VERSION}"
	git push origin ${ONDEWO_PACKAGE_VERSION}
